...
export const transactionSchema = z.object({
  ...
  sellerAgentCompany: z.string().optional(),
  sellerAgentPhone: z.string().optional(),
  sellerAgentEmail: z.string().optional(),
  buyerAgentId: z.string().optional(),
  buyerAgentIsInHouse: z.boolean().optional(),
  buyerAgentCompany: z.string().optional(),
  buyerAgentPhone: z.string().optional(),
